...
#
# - What is the base address of the msg chain? Its end address? begin: 0x6c6c6548 / end: 0x61746164
...
li a7, 04 # system call number 4 according to the RARS printString doc
